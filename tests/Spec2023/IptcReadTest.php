...
class IptcReadTest extends TestCase
{
    ...
    public function testIptcCoreIntellectualGenre()
    {
        $iptc = $this->readIptc();
    ...
    public function testIptcExtContributors()
    {
        ...
        $this->assertEquals(
            [
                ...
                [
                    "identifiers" => [
                        0 => "Contributor Id 2 (ref2023.2)"
                    ],
                    "name"        => [
                        "en" => "Contributor Name 2 (ref2023.2)"
                    ],
                    "role"        => [
                        0 => "https://example.com/contributor-role-cv/ref2023.2-2)"
                    ]
                ]
            ],
    ...
    public function testIptcExtDigitalSourceType()
    {
        $iptc = $this->readIptc();
    ...
    public function testIptcExtModelAges()
    {
        $iptc = $this->readIptc();
    ...
    public function testIptcExtRegistryEntries()
    {
        ...
        $this->assertEquals(
            [
                ...
                [
                    "role"               => "Registry Entry Role ID 2 (ref2023.2)",
                    "assetIdentifier"    => "Registry Image ID 2 (ref2023.2)",
                    "registryIdentifier" => "Registry Organisation ID 2 (ref2023.2)"
                ]
            ],
    ...
    public function testIptcExtCopyrightOwners()
    {
        ...
        $this->assertEquals(
            [
                ...
                [
                    "copyrightOwnerId"   => "Copyright Owner Id 2 (ref2023.2)",
                    "copyrightOwnerName" => "Copyright Owner Name 2 (ref2023.2)"
                ]
            ],
    ...
    public function testIptcExtOtherConstraints()
    {
        $iptc = $this->readIptc();
    ...
    public function testIptcExtImageRating()
    {
        $iptc = $this->readIptc();
